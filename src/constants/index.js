  ...
  const experiences = [
    {
      ...
      points: [
        ...
        "Learning the process of theaching and the art behind it.",
      ],
    },
    {
      title: "Java Developer",
    ...
    {
      title: "Web Developer",
      company_name: "Millenium Progress Accadamy",
      icon: shopify,
      iconBg: "#383E56",
      date: "Aug 2024 - Present",
      points: [
        "Developing and maintaining web applications using React.js and other related technologies.",
        "Collaborating with cross-functional teams including designers, clients, product managers, and other developers to create high-quality products.",
